...
public class Auto_DriveToTargetWithIntake extends State {
    ...
    public Auto_DriveToTargetWithIntake(double targetx, double targety, double power, MonkeyMotor br, MonkeyMotor bl, MonkeyMotor fr, MonkeyMotor fl, Intake intake){
        this.br = br;
        this.bl = bl;
        this.fr = fr;
        this.fl = fl;
